...
# Run this in Google Colab, one section at a time
# ============================================================


# ── SECTION 0: Install packages ─────────────────────────────
# Run this cell first, then wait for it to finish
...
# This takes ~10 minutes — don't interrupt it
...
X_train = impute(X_train_raw, train_medians)
X_valid = impute(X_valid_raw, train_medians)
X_test  = impute(X_test_raw,  train_medians)

print(f"✅ Feature matrix shape: {X_train.shape}")
print(f"   No NaNs: {not np.isnan(X_train).any()}")


# ── SECTION 5: Save arrays (share these with teammates) ─────
...
print("✅ Saved! Download and share with Person 2 and 3.")

# To download in Colab, run this:
# from google.colab import files
# for f in ['X_train.npy','X_valid.npy','X_test.npy','y_train.npy','y_valid.npy','y_test.npy']:
#     files.download(f)
...
# Find best weight on validation set
...
# ⚠️  Run this only once, at the very end, with your whole team
